...
/**
 * Renders the SVG to a canvas and downloads as a high-res PNG (2x scale).
 */
export function downloadPNG(svgContent: string, filename: string = 'd2-diagram', scale: number = 2, isDark: boolean = true) {
